...
let comparison2 = 10 === 10; // 일치(===) Strict Equality 
...
// Truthy and Falsy (about A not operator)
let falsy1 = !'' // => true
let truthy1 = !'hello' // => false
let falsy2 = !undefined // => true
let falsy3 = !null // => true
let falsy4 = !0 // => true
let falsy5 = !NaN // => true
console.log(falsy1, falsy2, falsy3, falsy4, falsy5, truthy1)
...
// 해당되는거 모두 가져와서 저장하기 때문에 뽑아쓰려면 인덱스 값으로
...
// Ternary Operator (삼항 연산자), ?는 true일 경우, :는 false일 경우
let a = true;
let b = false;

console.log(a ? 1 : 2); // result: 1
console.log(b ? 1 : 2); // result: 2